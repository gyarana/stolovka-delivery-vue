...
<h4 class="my-4 my-cart">Моя корзина</h4>
  <div class="d-flex my-3" style="justify-content: space-between;">
    <h4 class="fw-600">Стоимость</h4>
    <h4 class="fw-600" style="margin-right: 49%;">Корзина</h4>
  </div>
  <div class="d-flex">
        ...
        <ul style="padding: 0">
          ...
          <div class="cart-items">
            ...
            <div class="d-flex mt-10">
              ...
              <button v-on:click="addItem(items)" class="remove" type="button">+</button>
              </div>
...
<div class="d-flex justify-content-end" style="width: 80%;margin-top: 2%">
  <button v-on:click="checkout" class="btn btn-primary" type="button">Оформить покупку</button>
</div>
</div>
  <EmptyCart v-else />
</div>
  ...
  methods:{
    ...
    checkout(){
      swal({
        ...
        text: "НАШ ОПЕРАТОР С ВАМИ СВЯЖЕТЬСЯ",
        type: "success"
      }).then(function() {
